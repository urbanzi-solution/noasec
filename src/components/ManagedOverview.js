...
const deliverables = [
  {
    ...
    desc: "Round-the-clock surveillance of your digital landscape, ensuring no anomaly goes unnoticed, regardless of the hour.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Expert configuration of Wazuh, Splunk, or ELK stacks tailored to your specific data flow and ingestion requirements.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Alert Triage",
    desc: "Advanced noise reduction to eliminate false positives, allowing your team to focus only on validated critical threats.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Integration of global threat feeds to proactively hunt for emerging attack vectors before they reach your perimeter.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Comprehensive executive summaries and technical deep-dives detailing your posture and mitigated risks.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "IR Coordination",
    desc: "Seamless transition from detection to containment with our dedicated Incident Response specialists.",
  },
];
    ...
    <div className="bg-[#0a0a0a] text-white px-6 py-20 max-w-6xl mx-auto">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
        ...
        <div className="space-y-5 text-gray-400 text-sm leading-relaxed">
          <p>
           Building and running an in-house Security Operations Center is resource-intensive. NoaSec's Managed SOC Operations service delivers continuous 24/7 monitoring, threat detection, and incident triage — powered by industry-standard SIEM platforms — so your organization benefits from enterprise-grade protection without the overhead.
          </p>
        </div>
      </section>
