...
const deliverables = [
  {
    ...
    desc: "Securing kernels, shell access, and minimizing attack surfaces through strict policy enforcement.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Active Directory orchestration with robust Group Policy Objects (GPO) and domain architecture.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Implementing Least Privilege Access (LPA) principles and Multi-Factor Authentication (MFA) across all nodes.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "24/7 health checks and security telemetry to identify anomalies before they escalate into incidents.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Automated and validated updates for OS and critical software to eliminate known vulnerabilities.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Encrypted, redundant backup workflows following the 3-2-1 rule for absolute data integrity.",
  },
];
