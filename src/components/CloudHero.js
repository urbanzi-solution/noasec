    ...
    <section className="bg-[#050b14] text-white px-6 md:px-12 lg:px-20 py-24">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
         ...
         Cloud environments introduce unique security challenges — misconfigured storage buckets, over-privileged IAM roles, exposed APIs, and insecure container workloads. NoaSec's Cloud Security Solutions address these risks through cloud security audits, configuration hardening, and cloud penetration testing across AWS, Azure, and Google Cloud Platform.
          </p>
        ...
        <div className="relative">
          <div className="relative rounded-xl overflow-hidden border border-blue-500/20 shadow-[0_0_40px_rgba(59,130,246,0.2)]">
            ...
            <Image
              src="/cloud-evidence.jpg" // replace with your image
              alt="Cloud Evidence Collection"
              width={600}
              height={200}
              loading="lazy"
