...
const deliverables = [
  {
    ...
    title: "Rapid Triage",
    desc: "Immediate assessment of breach scope, impact, and critical asset risk within the first 60 minutes.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Forensically sound acquisition of memory, logs, and disk images to support legal and regulatory needs.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Malware Eradication",
    desc: "Deep reverse engineering of suspicious binaries to find and eliminate persistent threats and backdoors.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Surgical network segmentation to stop lateral movement without interrupting unaffected business operations.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Deep-dive analysis to determine the threat actor, attack vector, and data exfiltration details.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Guided restoration of services coupled with strategic policy updates to prevent re-infection.",
  },
];
...
export default function IncidentOverview() {
  return (
    <div className="bg-[#0a0a0a] text-white px-6 py-20 max-w-6xl mx-auto">
      ...
      {/* ── SERVICE OVERVIEW ── */}
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20 -mt-10">
        {/* Left */}
        <div>
        ...
        <div className="space-y-5 text-gray-400 text-sm leading-relaxed">
          <p>
         When a security incident occurs, speed and precision are critical. NoaSec's Incident Response service provides rapid containment, thorough investigation, and structured recovery — minimizing damage, downtime, and data loss. Our team follows a proven IR lifecycle: Preparation → Detection → Containment → Eradication → Recovery → Lessons Learned.
          </p>
        </div>
      </section>
