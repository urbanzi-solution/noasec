...
const deliverables = [
  {
    ...
    title: "Forensic imaging (HDD/SSD)",
    desc: "Full physical bit-stream copies of all storage media without altering original data.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Meticulous tracking of evidence from the moment of seizure to final courtroom presentation.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Live system acquisition (RAM)",
    desc: "Capturing volatile memory to identify running processes, decryption keys, and active threats.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Professional testimony to validate forensic findings in civil and criminal proceedings.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Write-blocking/Hash verification",
    desc: "Hardware-level protection to prevent data writes, verified by cryptographic hashing.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Evidence preservation in access-controlled, air-gapped forensic vaults.",
  },
];
