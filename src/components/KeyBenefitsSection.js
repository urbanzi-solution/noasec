...
const benefits = [
  {
    title: "Reconstruct exactly what happened",
    desc: "Move beyond logs to physical evidence on the platter and in the RAM.",
  },
  {
    title: "Recover data attackers attempted to destroy",
    desc: "Identify file deletions and anti-forensics techniques used to hide footprints.",
  },
  {
    title: "Court-admissible forensic reports",
    desc: "Evidence handled with chain-of-custody protocols ready for litigation.",
  },
  {
    title: "Understand attacker dwell time",
    desc: "Precise timestamps reveal how long an adversary has been in your network.",
  },
];
